...
function b(p){for(var u=g,r=0;64>r;r+=4)u[r/4]=p[r]<<24|p[r+1]<<16|p[r+2]<<8|p[r+3];for(r=16;80>r;r++)p=u[r-3]^u[r-8]^u[r-14]^u[r-16],u[r]=(p<<1|p>>>31)&4294967295;p=e[0];var A=e[1],D=e[2],T=e[3],sd=e[4];for(r=0;80>r;r++){if(40>r)if(20>r){var Ua=T^A&(D^T);var Zb=1518500249}else Ua=A^D^T,Zb=1859775393;else 60>r?(Ua=A&D|T&(A|D),Zb=2400959708):(Ua=A^D^T,Zb=3395469782);Ua=((p<<5|p>>>27)&4294967295)+Ua+sd+Zb+u[r]&4294967295;sd=T;T=D;D=(A<<30|A>>>2)&4294967295;A=p;p=Ua}e[0]=e[0]+p&4294967295;e[1]=e[1]+
A&4294967295;e[2]=e[2]+D&4294967295;e[3]=e[3]+T&4294967295;e[4]=e[4]+sd&4294967295}
...
od.prototype.reset=function(){this.next=this.scope=this.f=null};function qd(a,b){rd||td();ud||(rd(),ud=!0);vd.add(a,b)}
var rd;function td(){if(w.Promise&&w.Promise.resolve){var a=w.Promise.resolve(void 0);rd=function(){a.then(wd)}}else rd=function(){var b=wd;
...
function $h(a,b,c){b=void 0===b?{}:b;c=void 0===c?Zh[a]:c;Wh.call(this,c,Object.assign({name:"YtIdbKnownError",isSw:void 0===self.document,isIframe:self!==self.top,type:a},b));this.type=a;this.message=c;Object.setPrototypeOf(this,$h.prototype)}
...
ei.prototype.abort=function(){this.f.abort();this.aborted=!0;var a=new $h("EXPLICIT_ABORT");a.sampleWeight=0;throw a;};
...
(b=Object.assign({csn:cj()},b)),k){var k=parseInt(k,10);isFinite(k)&&0<k&&(e=b,b="ST-"+Vb(d).toString(36),e=e?$b(e):"",Ff(b,e,k||5))}else k=b,e="ST-"+Vb(d).toString(36),k=k?$b(k):"",Ff(e,k,5)}}if(c)return!1;if((window.ytspf||{}).enabled)spf.navigate(a);else{var l=void 0===l?{}:l;var m=void 0===m?"":m;var p=void 0===p?window:p;c=p.location;a=ac(a,l)+m;a=a instanceof I?a:Kb(a);c.href=Gb(a)}return!0}
...
function dl(a){var b;(b=y("ytcsi."+(a||"")+"data_"))||(b={tick:{},info:{}},Ta("ytcsi."+(a||"")+"data_",b));return b}
...
window.addEventListener?(window.addEventListener("load",Jl),window.addEventListener("unload",Kl)):window.attachEvent&&(window.attachEvent("onload",Jl),window.attachEvent("onunload",Kl));Ta("yt.abuse.player.botguardInitialized",y("yt.abuse.player.botguardInitialized")||Ri);Ta("yt.abuse.player.invokeBotguard",y("yt.abuse.player.invokeBotguard")||Si);Ta("yt.abuse.dclkstatus.checkDclkStatus",y("yt.abuse.dclkstatus.checkDclkStatus")||lg);
Ta("yt.player.exports.navigate",y("yt.player.exports.navigate")||gj);Ta("yt.util.activity.init",y("yt.util.activity.init")||xg);Ta("yt.util.activity.getTimeSinceActive",y("yt.util.activity.getTimeSinceActive")||Ag);Ta("yt.util.activity.setTimestamp",y("yt.util.activity.setTimestamp")||yg);}).call(this);
